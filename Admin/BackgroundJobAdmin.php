...
namespace Accurateweb\JobQueueBundle\Admin;

use Accurateweb\JobQueueBundle\Model\BackgroundJob;
use Accurateweb\JobQueueBundle\Service\Logger\BackgroundJobLogFileResolver;
...
class BackgroundJobAdmin extends AbstractAdmin
{
  ...
  public function getTemplate ($name)
  {
    if ($name == 'show')
    {
      return 'AccuratewebJobQueueBundle::show.html.twig';
    }
