...
namespace Accurateweb\JobQueueBundle\Service\BackgroundJob;
...
use Accurateweb\JobQueueBundle\Model\MetaData;
...
class BackgroundJobManager
{
  ...
  /**
   * @param $clsid
   * @throws \Accurateweb\JobQueueBundle\Exception\BackgroundJobNotExistsException
   */
  ...
  public function addToQueue(BackgroundJobInterface $jobService, MetaData $metaData=null)
  {
    ...
    {
      throw new InvalidParameterException(sprintf('BackgroundJobRepository entities should implement Accurateweb\JobQueueBundle\Model\BackgroundJob'));
    }
